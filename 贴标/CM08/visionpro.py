...
def visionproLoad():
    ...
    try:
        ...
        #加载工作 
        job=[QuickBuild.Job(i) for i in range(0,1)]
        #加载工具
        myImgTool=[job[i].VisionTool.Tools["Image Source"] for i in range(0,1)]
        myCircleTool=[job[i].VisionTool.Tools["CogFindCircleTool1"] for i in range(0,1)]
        myCircleTool2=[job[i].VisionTool.Tools["CogFindCircleTool2"] for i in range(0,1)]
        myLineTool=[job[i].VisionTool.Tools["CogFindLineTool1"] for i in range(0,1)]
        myPMAlignTool=[job[i].VisionTool.Tools["CogPMAlignTool1"] for i in range(0,1)]
        myFixtureTool=[job[i].VisionTool.Tools["CogFixtureTool1"] for i in range(0,1)]
        return 1
