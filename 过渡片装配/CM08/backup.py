# -*- coding: utf-8 -*-
"""
Created on Sun Jan  7 15:31:53 2018
    ...
    def __init__(self):
        ...
        paraName=["tPsheetTotal","tPsheetGood","tPsheetGoodRate","tPsheetBad","tPsheetBadRate","tPsheetFail",
                  ...
                  "tNsheetTotal","tNsheetGood","tNsheetGoodRate","tNsheetBad","tNsheetBadRate","tNsheetFail",
                   ...
                   "tPsheetSn","tNsheetSn","tPplateSn","tNplateSn"]
        paraData=[self.tPsheetTotal.toPlainText(),
                  ...
                  self.tPsheetSn.toPlainText(),
                  self.tNsheetSn.toPlainText(),
                  self.tPplateSn.toPlainText(),                 
                  self.tNplateSn.toPlainText()]
        #用于从数据库获取的值
        paraDataSet=[]        
...
#        cursor.execute('select * from para ') 
        ...
        self.tPsheetSn.setText(paraDataSet[25])
        self.tNsheetSn.setText(paraDataSet[26])
        self.tPplateSn.setText(paraDataSet[27])
        self.tNplateSn.setText(paraDataSet[28])
